...
type PL_LogSignerConfig struct {
...
func (config *PL_LogSignerConfig) Equal(config_ *PL_LogSignerConfig) bool {
...
func PL_saveLogSignerConfigToFile(config *PL_LogSignerConfig, configPath string) error {
	return common.Json_WriteStrucToFile(config, configPath)
}

func PL_ReadLogSignerConfigFromFile(config *PL_LogSignerConfig, filePath string) error {
