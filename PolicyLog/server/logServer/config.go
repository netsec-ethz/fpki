...
type PL_LogServerConfig struct {
...
func (config *PL_LogServerConfig) Equal(config_ *PL_LogServerConfig) bool {
...
func PL_saveLogConfigToFile(config *PL_LogServerConfig, configPath string) error {
	return common.Json_WriteStrucToFile(config, configPath)
}

func PL_ReadLogConfigFromFile(config *PL_LogServerConfig, filePath string) error {
